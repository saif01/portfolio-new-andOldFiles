...
<head>
    ...
    <!--template title-->
    <title>Syful Islam Portfolio</title>
    ...
    <link href="assets/custom/textAnimate/animate.css" rel="stylesheet">
    <style>
        .animated_text {
        ...
        .custom_btn {
            background: -webkit-linear-gradient(92deg, #000000, #FF1493) !important;
        }
    </style>
...
<body>
                    ...
                    <div class="main-menu">
                        <div class="navbar navbar-cus">
                            <div class="navbar-header">
                                <a href="index.html" class="navbar-brand"><span class="logo">Syful Islam</span></a>
                                <!--edit site name here-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <section class="intro animate-scale">
                                    ...
                                    <h3 class="tlt animated_text text_shado">Welcome to My Website</h3>

                                    <h1 class="ah-headline">

                                        <span class="ah-words-wrapper text_shado">
                                            <b class="is-visible">Mason Smith</b>
                                    ...
                                    <a href="#contact" class="banner-btn custom_btn">Contact me</a>
            ...
            <div class="row">
                <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                    <div class="about-text-left">
                        ...
                        <a href="images/about/demo-cv.png" class="custom_btn" download>Download CV &nbsp; &nbsp;<i class="fa fa-download"></i></a>
                    </div>
                </div>

                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <img src="assets/images/about/about.png" class="img-responsive" alt="about image">
                    <!--add your image here-->
                </div>
                        ...
                        <div id="inline-popups" class="port-box">
                            <a href="#test-popup" data-effect="mfp-zoom-out">
                                <div class="hovereffect">
                                    ...
                                    <img src="assets/images/portfolio/port1.png" alt="portfolio image" class="img-responsive">
                                    <!--edit image-->
                                    <div class="overlay">
                                        <h2>Project One</h2>
                                        <!--your project name-->
                        ...
                        <div id="inline-popups-2">
                            <a href="#test-popup-2" data-effect="mfp-zoom-out">
                                <div class="hovereffect">
                                    ...
                                    <img src="assets/images/portfolio/port2.png" alt="portfolio image" class="img-responsive">
                                    <!--edit image-->
                                    <div class="overlay">
                                        <h2>Project Two</h2>
                                        <!--your project name-->
                        ...
                        <div id="inline-popups-3">
                            <a href="#test-popup-3" data-effect="mfp-zoom-out">
                                <div class="hovereffect">
                                    ...
                                    <img src="assets/images/portfolio/port3.png" alt="portfolio image" class="img-responsive">
                                    <!--edit image-->
                                    <div class="overlay">
                                        <h2>Project Three</h2>
                                        <!--your project name-->
                        ...
                        <div id="inline-popups-4">
                            <a href="#test-popup-4" data-effect="mfp-zoom-out">
                                <div class="hovereffect">
                                    ...
                                    <img src="assets/images/portfolio/port4.png" alt="portfolio image" class="img-responsive">
                                    <!--edit image-->
                                    <div class="overlay">
                                        <h2>Project Four</h2>
                                        <!--your project name-->
                        ...
                        <div id="inline-popups-5">
                            <a href="#test-popup-5" data-effect="mfp-zoom-out">
                                <div class="hovereffect">
                                    ...
                                    <img src="assets/images/portfolio/port5.png" alt="portfolio image" class="img-responsive">
                                    <!--edit image-->
                                    <div class="overlay">
                                        <h2>Project Five</h2>
                                        <!--your project name-->
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 no-pad">
                        ...
                        <div id="inline-popups-6">
                            <a href="#test-popup-6" data-effect="mfp-zoom-out">
                                <div class="hovereffect">
                                    ...
                                    <img src="assets/images/portfolio/port6.png" alt="portfolio image" class="img-responsive">
                                    <!--edit image-->
                                    <div class="overlay">
                                        <h2>Project Six</h2>
                                        <!--your project name-->
                        ...
                        <div id="test-popup-6" class="white-popup mfp-with-anim mfp-hide">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="por-img">
                                        <img src="assets/assets/images/portfolio/port6.png" alt="portfolio image" class="img-responsive">
                                        <!--edit image-->
                                    </div>
                                </div>
                                <div class="col-md-5">
                    ...
                    <div class="review-area">
                        <div id="testimonial-carousel" class="owl-carousel owl-theme">
                            <div class="single-testi text-center item">
                                <div class="testi-img">
                                    <img src="assets/images/testimonial/testi-1.png" alt="testimonial image">
                                    <!--edit image-->
                                </div>
                                <div class="block-quote">
                                    <p>My Experience working with Mason has been very positive. I always receive quality service from him. I highly recommend this guy to everyone because I think he is one a of kind.</p>
                                    <!--edit here-->
                                    <h2>Jane Doe</h2>
                                    <!--edit here-->
                                    <h3>CEO, Houston</h3>
                            ...
                            <div class="single-testi text-center item">
                                <div class="testi-img">
                                    <img src="assets/images/testimonial/testi-2.png" alt="testimonial image">
                                    <!--edit image-->
                                </div>
                                <div class="block-quote">
                                    <p>My Experience working with Mason has been very positive. I always receive quality service from him. I highly recommend this guy to everyone because I think he is one a of kind.</p>
                            ...
                            <div class="single-testi text-center item">
                                <div class="testi-img">
                                    <img src="assets/images/testimonial/testi-3.png" alt="testimonial image">
                                    <!--edit image-->
                                </div>
                                <div class="block-quote">
                                    <p>My Experience working with Mason has been very positive. I always receive quality service from him. I highly recommend this guy to everyone because I think he is one a of kind.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                    <p>&copy; All Right Reserved By <a href="https://www.codester.com/user/MouriTheme/" target="_blank">MouriTheme</a></p>
                    <!--edit here-->
                </div>
            </div>
        </div>
    ...
    <!-- Animated Text JS -->
    <script src="assets/custom/textAnimate/jquery.lettering.js"></script>
    <script src="assets/custom/textAnimate/jquery.textillate.js"></script>
    <script src="assets/custom/textAnimate/animateOptions.js"></script>
